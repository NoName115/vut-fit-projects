...
void htClearAll ( tHTable* ptrht ) {
	...
	for (int i = 0; i < HTSIZE; ++i)
	{
		...
		while (tempItem != NULL)
		{
			tHTItem* nextItem = tempItem->ptrnext;
			free(tempItem);
			tempItem = nextItem;
		}
