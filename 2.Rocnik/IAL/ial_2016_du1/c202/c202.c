...
*/
	...
	//Priradi hodnotu z vrcholu zasobnika
	//do premennej c
	*c = s->arr[s->top];
...
*/
	...
	//Posuniem zasobnik o 1 alias odstranim prvok
	//ostane trash v zasobniku
	s->top -= 1;
...
*/
	...
	//Posuniem zasovnik a pridam hodnotu
	s->top += 1;
	s->arr[s->top] = c;
